...
<input class="form-control" placeholder="Votre Nom" type="text" id="lastnameCustomer" name="lastnameCustomer" size="30" maxlength="30" />
<span class="erreur">${form.errors['lastnameCustomer']}</span>
<br />

<label for="firstnameCustomer">Prénom </label>
<input class="form-control" placeholder="Votre Prenom" type="text" id="firstnameCustomer" name="firstnameCustomer" size="30" maxlength="30" />
...
<input class="form-control" placeholder="rue des assticots" type="text" id="addressCustomer" name="addressCustomer" size="30" maxlength="60" />
<span class="erreur">${form.errors['addressCustomer']}</span>
<br />

<label for=postCodeCustomer>Code postal <span class="requis">*</span></label>
<input class="form-control" placeholder="74100" type="text" id="postCodeCustomer" name="postCodeCustomer" size="30" maxlength="60" />
<span class="erreur">${form.errors['postCodeCustomer']}</span>
<br />

<label for="cityCustomer">Ville<span class="requis">*</span></label>
<input class="form-control" placeholder="Vetraz Morel" type="text" id="cityCustomer" name="cityCustomer" size="30" maxlength="60" />
...
<input class="form-control" placeholder="0657290102" type="text" id="phonenumberCustomer" name="phonenumberCustomer" size="30" maxlength="30" />
<span class="erreur">${form.errors['phonenumberCustomer']}</span>
<br />

<label for="emailCustomer">Adresse email</label>
<input class="form-control" placeholder="alice@ca-glice.fr" type="email" id="emailCustomer" name="emailCustomer" size="30" maxlength="60" />
