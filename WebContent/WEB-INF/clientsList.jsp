				...
				<table>
					...
					<c:forEach items="${ sessionScope.clients }" var="mapClients"
						...
						<tr class="${boucle.index % 2 == 0 ? 'pair' : 'impair'}">
							...
							<td><c:out value="${ mapClients.value.lastname }" /></td>
							<td><c:out value="${ mapClients.value.firstname }" /></td>
							<td><c:out value="${ mapClients.value.address }" /></td>
							<td><c:out value="${ mapClients.value.phonenumber }" /></td>
							...
							<td class="action"><a
								href="<c:url value="/clientRemoval"><c:param name="lastnameClient" value="${ mapClients.key }" /></c:url>">
