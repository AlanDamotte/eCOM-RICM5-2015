                ...
                <div class="section">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-sm-2 col-md-2 text-center"><c:if test="${not empty sessionScope.cart_products}"><a>Total : <c:out value="${ sessionScope.cart_products.getTotal() }"/> euros</a></c:if></div><div class="col-sm-2 col-md-4"></div><div class="col-md-3 col-sm-2 text-center">
