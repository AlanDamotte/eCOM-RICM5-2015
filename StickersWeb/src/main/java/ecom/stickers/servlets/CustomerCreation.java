...
import ecom.stickers.forms.CustomerCreationForm;
...
public class CustomerCreation extends HttpServlet {
	...
	public static final String VIEW_SUCCES = "/displayCustomer.jsp";
	public static final String VIEW_FORM = "/createCustomer.jsp";
