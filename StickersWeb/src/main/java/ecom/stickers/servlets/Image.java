...
@WebServlet(name = "Image", urlPatterns = { "/images/*" }, initParams = @WebInitParam( name = "path", value = "/home/workplace-jee/Stickers/StickersWeb/src/main/webapp/bootstrap/img" ) )
